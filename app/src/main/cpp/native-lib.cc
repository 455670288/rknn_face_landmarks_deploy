...
extern "C"
JNIEXPORT jint JNICALL Java_com_rockchip_gpadc_demo_yolo_InferenceWrapper_navite_1face_1init
		(JNIEnv *env, jobject obj, jint im_height, jint im_width, jint im_channel,
		 jstring model_path_face)
{
	char *model_path_p = jstringToChar(env, model_path_face);
	return create_face(im_height, im_width, im_channel, model_path_p);
}
...
extern "C"
JNIEXPORT jint JNICALL Java_com_rockchip_gpadc_demo_yolo_InferenceWrapper_native_1inference
        (JNIEnv *env, jobject obj) {
...
JNIEXPORT jint JNICALL Java_com_rockchip_gpadc_demo_yolo_InferenceWrapper_native_1run
  (JNIEnv *env, jobject obj, jbyteArray in,
   jfloatArray grid0Out, jfloatArray grid1Out, jbyteArray grid2Out) {
