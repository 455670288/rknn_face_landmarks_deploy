...
public class SimpleLipFilter extends AGLFilter {

    private static final String TAG = SimpleLipFilter.class.getSimpleName();
    ...
    public SimpleLipFilter(Context context) {
        super(context);
    }
